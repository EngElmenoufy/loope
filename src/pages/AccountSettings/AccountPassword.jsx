  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className={`mb-1 ${!errorData.newPassword ? "pb-5" : ""}`}>
          <label
            htmlFor="newPassword"
            className="block text-base font-semibold text-gray-800"
          >
          ...
          <div className="relative">
            <input
              ...
              className={`mt-1 tracking-wide ${errorData.newPassword ? "text-[#E14627]" : ""} block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none`}
        ...
        <div className={`mb-1 ${!errorData.confirmPassword ? "pb-5" : ""}`}>
          <label
