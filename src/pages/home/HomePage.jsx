    ...
    <div>
      <main className="mx-2 sm:mx-3 md:mx-6">
        <section className="grid grid-cols-8 gap-5 m-2 h-[50vh]">
          <a className="ad cursor-pointer col-span-8 lg:col-span-6 relative rounded-lg overflow-hidden grid grid-cols-2 transition-all bg-[#bac2c2] hover:shadow-lg">
        ...
        <ExploreProducts title={"Best Sales"} header={"Explore Our Products"}>
          {products.slice(0, 10).map((product) => (
            <li
              className="p-2 bg-white transition-all duration-300 rounded-lg shadow-sm hover:shadow-md cursor-pointer"
              key={product._id}
            >
        ...
        <ExploreProducts title={"Best Deals"} header={"Today's big deals"}>
