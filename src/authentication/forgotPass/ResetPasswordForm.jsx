      ...
      <div className={`mb-1 ${!errorNewPassword ? "pb-5" : ""}`}>
        ...
        <div className="relative">
          <input
            ...
            className={`mt-1 ${errorNewPassword ? "text-[#E14627]" : ""} block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none`}
            value={newPassword}
      ...
      <div className={`mb-1 ${!errorConfirmPassword ? "pb-5" : ""}`}>
        ...
        <div className="relative">
          <input
            ...
            className={`mt-1 ${errorConfirmPassword ? "text-[#E14627]" : ""} block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-gray-500`}
