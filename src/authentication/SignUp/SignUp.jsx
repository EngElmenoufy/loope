...
export default function SignUp() {
  ...
  const handleLNameBlur = () => {
    if (lastName.length === 0) {
      setErrorLName("Please enter your first name");
    }
  };
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Header */}
      <header className="bg-[#18403C] text-white p-4 flex justify-center">
      ...
      <main className="flex-grow flex flex-col md:flex-row items-center mt-10 md:mt-0 p-2 lg:p-6 gap-10">
        ...
        <div className="w-full lg:p-6">
          ...
          <form onSubmit={handleSubmit}>
            <div className={`mb-1 ${!errorFName ? "pb-5" : ""}`}>
              <label
                htmlFor="fname"
              ...
              <input
                ...
                className={`mt-1 ${errorFName ? "text-[#E14627]" : ""} block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none`}
            ...
            <div className={`mb-1 ${!errorLName ? "pb-5" : ""}`}>
              <label
                htmlFor="lname"
                className="block text-sm font-medium text-gray-700"
              >
              ...
              <input
                ...
                className={`mt-1 ${errorLName ? "text-[#E14627]" : ""} block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none`}
                placeholder="Enter your first name"
              />
              {errorLName && (
                <p className="text-sm text-[#E14627] h-[20px]">
            ...
            <button
              type="submit"
              className="w-full bg-[#18403C] text-white py-3 rounded hover:bg-[#0e5b53] transition duration-200 mb-4"
            >
              Create Account
            </button>
